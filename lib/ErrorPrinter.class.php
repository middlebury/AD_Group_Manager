...
<html>
	...
	<body>
		<div class='header'>
			<div class='segue_name'>Group Manager</div>
		...
		<p>$logMessage</p>
		<p>Usage Documentation: <a href='https://mediawiki.middlebury.edu/wiki/LIS/Group_Manager'>https://mediawiki.middlebury.edu/wiki/LIS/Group_Manager</a></p>
		$additionalHtml
	</body>
</html>
